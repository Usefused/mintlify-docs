...
- [Use a Managed service](/workspace/use-managed-service) where available, or [register your own OAuth application](/bucket/connect-user-accounts#store-the-oauth-app-credentials) in the MCP's selected bucket. Configure the exact auth scheme, scopes, and application reference before publishing.
