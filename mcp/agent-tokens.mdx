...
| `--fixed-binding` | Pins a service, auth scheme, and user at issuance; repeatable | `fused-cli mcp token generate support triage --fixed-binding 'jira,OAuth2,user_123'` |
