...
| `--fixed-binding` | Pins a service, auth scheme, and user at issuance; repeatable | `fused-cli mcp token generate support triage --fixed-binding '9f2c…,OAuth2,user_123'` |
...
```bash
fused-cli workspace access app grant <mcp-id>
```
