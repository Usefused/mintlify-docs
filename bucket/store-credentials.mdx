...
Location can be `env`, `body`, `query`, `header`, or `path`. The `env` namespace here is the bucket's own value store — it does not read an operating-system environment variable.
