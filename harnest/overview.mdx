...
description: "Fused's lightweight, capability-driven harness for going from zero to a complete, testable agent in minutes."
---
...
Harnest is capability-driven. If you do not add a tool, SubAgent, MCP connection, Agent Skill, plugin, sandbox, or lifecycle extension, Harnest does not wire it into the compiled agent.
