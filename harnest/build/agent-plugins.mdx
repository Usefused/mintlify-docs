...
Install a reviewed local package into an agent project:

```bash
harnest plugins install ./downloads/warehouse --project ./support-agent
```
...
`support-agent/plugins/<manifest-name>` through same-filesystem staging. It
