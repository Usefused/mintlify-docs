...
A Harnest Extension packages reusable application functionality. It runs in the agent process and can contribute declared lifecycle, context, storage, HTTP, content, and telemetry capabilities. It does not need to connect to an external service.
