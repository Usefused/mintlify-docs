...
The model uses the shared `OPENAI_MODEL`, `OPENAI_BASE_URL`, and `OPENAI_API_KEY` process environment. Follow [Configure a model](/harnest/build/models-and-libraries/configure-a-model) for local, CI, deployment, and OpenAI-compatible backend setup.
