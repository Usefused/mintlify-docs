...
`compile`, `test`, and `serve` synchronize the internal environment
automatically without changing the IDE link. CI can require a current committed
lock without resolving or changing it:
