...
Harnest validates and copies the package without importing its code. Version `0.2.0` requires Python 3.10 or newer, Harnest `>=0.18,<0.19`, and `hatchet-sdk>=1.38,<2`.
