...
Harnest validates and copies the package without importing its code. Version `0.1.1` requires Python 3.10 or newer, Harnest `>=0.15,<0.16`, and `hatchet-sdk>=1.38,<2`.
