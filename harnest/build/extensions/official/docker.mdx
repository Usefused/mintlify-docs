...
Harnest validates and copies the package without importing its code. Version `0.2.1` requires Python 3.10 or newer, Harnest `>=0.15,<0.16`, and `docker>=7.1,<8`. The host must provide a reachable Docker daemon.
