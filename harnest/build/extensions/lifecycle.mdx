...
The extension manifest must project lifecycle files through `contributes.lifecycle` and declare every Harnest capability those files use. Path declaration makes content visible to the compiler; capabilities authorize what that content may do. Neither grants access to undeclared runtime internals.
