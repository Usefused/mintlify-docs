...
Harnest resolves the complete environment before importing the agent or its Harnest Extensions. Use `harnest env sync AGENT_DIR --frozen` in CI to reject lock drift.
