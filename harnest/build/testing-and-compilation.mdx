...
| `test` command | Selects the pytest-backed test profile |
...
Harnest Extensions. Runtime, test, and eval use independent locks so deployment
does not inherit development-only packages.
