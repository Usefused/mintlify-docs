...
Local `harnest serve` listens on `127.0.0.1:8080` with the playground enabled by default. Compiled launchers serve the agent API without the playground. You do not need a separate server configuration file.
