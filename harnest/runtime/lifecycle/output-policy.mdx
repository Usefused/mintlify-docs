---
title: "Output policy"
description: "Control SubAgent narration, provider reasoning, and metadata disclosure."
---
...
@lifecycle.output_policy
def output_policy():
    return OutputPolicy(thinking="include")
```
...
| Provider-exposed reasoning | No | Yes, with `thinking="include"` |
