...
Authentication answers who made the request. An [Agent Runtime Principal](/harnest/runtime/agent-runtime-principals) separately limits which permissioned capabilities one invocation can use. Your application derives those grants after authentication; Harnest does not provide application RBAC.
