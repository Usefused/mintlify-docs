...
Authentication answers who made the request. An [Agent Runtime Principal](/harnest/runtime/agent-runtime-principals) separately establishes a default-deny capability boundary for one invocation. Your application derives those grants after authentication; Harnest does not provide application RBAC.
