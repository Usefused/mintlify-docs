...
runtime, and all transitives. Runtime, test, and eval profiles have separate
hash-verified locks so serving excludes pytest, evaluation, and unused MCP
packages.
...
| Test environment is current | `harnest env sync <project> --profile test` |
