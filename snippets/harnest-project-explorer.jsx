export const HarnestProjectExplorer = () => {
  ...
  },
  {
    "label": "config.yaml",
    "path": "config.yaml",
    "description": "Agent, framework, and runtime environment settings. Legacy resource and scaling blocks are ignored and not generated. Add an optional root server section to override local serving defaults. This preview uses ADK; select langgraph for a managed LangGraph project.",
    "code": "apiVersion: harnest.dev/v1alpha1\nkind: Agent\nmetadata:\n  name: support-agent\n  displayName: Support Agent\nspec:\n  enabled: true\n  entrypoint: agent:root_agent\n  framework:\n    name: adk\n    mode: managed\n  runtime:\n    version: \"3.12\"\n    dependencyFile: pyproject.toml\n  # Configure your compatible endpoint and model before live calls.\n  environment:\n    OPENAI_MODEL: your-model\n    OPENAI_BASE_URL: https://models.example.invalid/v1\n    OTEL_INSTRUMENTATION_GENAI_CAPTURE_MESSAGE_CONTENT: NO_CONTENT\n    ADK_CAPTURE_MESSAGE_CONTENT_IN_SPANS: \"false\"",
    "language": "yaml",
    "optional": false,
    "href": "/harnest/build/project-configuration",
    "example": false
  ...
  },
  {
    ...
    "path": "pyproject.toml",
    "description": "Your Python dependencies. Harnest supplies the framework; environment sync generates the selected Harnest environment lock.",
  ...
  },
  {
    "label": ".gitignore",
    "path": ".gitignore",
    "description": "Keeps generated environments, caches, and local build output out of source control.",
    "code": ".harnest/\n.venv\n__pycache__/\n.pytest_cache__/",
    "language": "text",
    "optional": false,
    "href": "/harnest/build/project-configuration",
  ...
  },
  {
    ...
    "code": "from harnest.agent import tool\n\n\n@tool\ndef echo(message: str) -> str:\n    \"\"\"Return a message unchanged.\"\"\"\n    return message",
    "language": "python",
    "optional": true,
