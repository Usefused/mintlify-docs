...
<Tip>
  To draft a sequential operation from a goal, use [prompt](/app/from-a-prompt#describe-a-sequential-operation). It resolves exact provider operations and shows the proposed order, inputs, mappings, and output before apply. You can still author the full configuration directly below.
</Tip>
