...
| Your own provider application | You need your own app identity, provider settings, or a service without a managed offering | Stored in your Engine bucket |
