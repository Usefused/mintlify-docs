...
<CardGroup cols={2}>
  ...
  <Card title="Self-hosted" icon="server">
    Run the Engine in your own infrastructure and own its credential storage, execution, and records. You can also opt into [Managed services](/workspace/use-managed-service) for provider authentication and event brokering. The rest of this page covers deployment.
  </Card>
</CardGroup>
