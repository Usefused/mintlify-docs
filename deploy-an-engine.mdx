...
- **A Fused license key**, from your Fused onboarding contact or the dashboard.
...
|---|---|
| `FUSED_DATABASE_MAX_CONNS` | Pool ceiling; standalone defaults to `10`, hosted starter Engines to `2` |
| `FUSED_DATABASE_MAX_CONN_IDLE_TIME` | Idle retention; standalone `30m`, hosted `2m` |
...
- **Check your licence terms.** The Engine is source-available under PolyForm Noncommercial 1.0.0. Commercial or production use needs a separate written agreement with Fused in addition to a valid key.
